...
import { closeButton } from '../model/model'

export default function CloseButton({closeClick}:closeButton) {
  ...
  return (
    <div onClick={closeHandle} className='bg-white w-8 h-8 rounded-full '>
